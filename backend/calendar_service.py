...
# ✅ Resolve absolute path to credential file
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
SERVICE_ACCOUNT_FILE = os.path.abspath(os.path.join(BASE_DIR, "../config/credential.json"))
...
# ✅ Target calendar ID (ensure service account has access)
...
# ✅ NEW: Suggest free slot for a given day
...
# ✅ Create event with conflict check and fallback
